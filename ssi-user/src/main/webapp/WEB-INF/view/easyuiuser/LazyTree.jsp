...
<div class="easyui-panel" style="padding:5px">
		...
		<ul class="easyui-tree" data-options="url:'<%=request.getContextPath()%>/category/findCategoryTongbu.jhtml',method:'post',animate:true,lines:true"></ul>
